...
def apply_style():
    st.markdown(
        ...
        [data-testid="stSidebarContent"]{padding-bottom:188px!important}
        .st-key-bw_sidebar_footer{position:fixed!important;left:0;bottom:0;width:236px;z-index:1000;box-sizing:border-box;padding:.7rem .75rem .62rem;background:#14243a;border-top:1px solid rgba(255,255,255,.10);box-shadow:0 -8px 18px rgba(20,36,58,.24)}
        ...
        @media(max-width:1100px){[data-testid="stSidebar"]{min-width:190px;max-width:190px}.st-key-bw_sidebar_footer{width:190px}.st-key-bw_sidebar_footer .bw-ci-logo svg{width:152px}.block-container{padding:1rem}.st-key-bw_topbar{margin:-1rem -1rem .8rem}.bw-kpi{min-height:118px;padding:11px}.bw-kpi-value{font-size:1rem}.bw-mini-grid{grid-template-columns:repeat(2,1fr)}}
