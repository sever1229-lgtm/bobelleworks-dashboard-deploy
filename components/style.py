...
def apply_style():
    st.markdown(
        ...
        .st-key-bw_sidebar_footer{position:fixed!important;left:0;bottom:0;width:236px;z-index:1000;box-sizing:border-box;padding:.7rem .75rem .62rem;background:#14243a;border-top:0;box-shadow:none}
