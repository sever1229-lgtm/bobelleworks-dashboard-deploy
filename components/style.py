...
def apply_style():
    st.markdown(
        ...
        .bw-brand-panel{margin:1rem -.75rem -1rem;padding:4.2rem 1.1rem 1.25rem;background:linear-gradient(160deg,rgba(255,255,255,.02),rgba(255,255,255,.12));border-top:1px solid rgba(255,255,255,.08);font-size:.72rem;line-height:1.65;color:#cbd6e5}.bw-brand-panel b{display:block;color:#fff;font-size:.82rem;margin-bottom:4px}
        ...
        @media(max-width:1100px){[data-testid="stSidebar"]{min-width:190px;max-width:190px}.block-container{padding:1rem}.st-key-bw_topbar{margin:-1rem -1rem .8rem}.bw-kpi{min-height:118px;padding:11px}.bw-kpi-value{font-size:1rem}.bw-mini-grid{grid-template-columns:repeat(2,1fr)}}
